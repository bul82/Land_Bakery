...
PROJECT_NAME = "land-bakery"
LOCAL_DIR = "/Users/bul82/Documents/Land_Bakery"
...
def deploy():
    print(f"=== Land Bakery VPS Deployment ===")
    ...
    ssh.close()
    print("\n=== Land Bakery VPS Deployment Completed Successfully! ===")
